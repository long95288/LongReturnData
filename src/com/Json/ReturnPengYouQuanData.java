...
/**
 * Servlet implementation class ReturnPengYouQuanData
 */
@WebServlet("/ReturnPengYouQuanData")
public class ReturnPengYouQuanData extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReturnPengYouQuanData() {
        super();
